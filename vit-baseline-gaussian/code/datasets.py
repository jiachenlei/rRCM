...
def get_dataset(dataset: str, split: str, autoaug=False) -> Dataset:
    """Return the dataset as a PyTorch Dataset object"""
    if dataset == "imagenet":
        return _imagenet(split, autoaug=autoaug)
...
def get_normalize_layer(dataset: str, normalize_stats="0.5") -> torch.nn.Module:
    """Return the dataset's normalization layer"""
    if dataset == "imagenet":
        if normalize_stats == "0.5":
...
def _imagenet(split: str, autoaug=False) -> Dataset:
